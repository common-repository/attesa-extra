...
/** AWP_Parser class */
require AE_PATH . '/panel/classes/importers/parsers/class-awp-parser.php';

/** AWP_Parser_SimpleXML class */
require AE_PATH . '/panel/classes/importers/parsers/class-awp-parser-simplexml.php';

/** AWP_Parser_XML class */
require AE_PATH . '/panel/classes/importers/parsers/class-awp-parser-xml.php';

/** AWP_Parser_Regex class */
require AE_PATH . '/panel/classes/importers/parsers/class-awp-parser-regex.php';

function awp_importer_init() {
	/**
	 * WordPress Importer object for registering the import callback
	 * @global WP_Import $wp_import
	 */
	$GLOBALS['wp_import'] = new WP_Import();
	register_importer( 'wordpress', 'WordPress', __('Import <strong>posts, pages, comments, custom fields, categories, and tags</strong> from a WordPress export file.', 'ocean-extra'), array( $GLOBALS['wp_import'], 'dispatch' ) );
}
add_action( 'admin_init', 'awp_importer_init' );
